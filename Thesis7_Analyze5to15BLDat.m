...
% Get bootstrapped samples & perform direct probability test
tstart=tic;
[M_IL_theta_boot,F_IL_theta_boot,MF_IL_theta_p_test,MF_thetapjm_IL] = BootStat_MvF(M_IL_theta,F_IL_theta); %mPFC-IL
[M_IL_gamma_boot,F_IL_gamma_boot,MF_IL_gamma_p_test,MF_gammapjm_IL] = BootStat_MvF(M_IL_gamma,F_IL_gamma);
[M_IL_delta_boot,F_IL_delta_boot,MF_IL_delta_p_test,MF_deltapjm_IL] = BootStat_MvF(M_IL_delta,F_IL_delta);
 [M_DH_theta_boot,F_DH_theta_boot,MF_DH_theta_p_test,MF_thetapjm_DH] = BootStat_MvF(M_DH_theta,F_DH_theta); %dHPC
 [M_DH_gamma_boot,F_DH_gamma_boot,MF_DH_gamma_p_test,MF_gammapjm_DH] = BootStat_MvF(M_DH_gamma,F_DH_gamma);
 [M_DH_delta_boot,F_DH_delta_boot,MF_DH_delta_p_test,MF_deltapjm_DH] = BootStat_MvF(M_DH_delta,F_DH_delta);
[M_VH_theta_boot,F_VH_theta_boot,MF_VH_theta_p_test,MF_thetapjm_VH] = BootStat_MvF(M_VH_theta,F_VH_theta); %vHPC
[M_VH_gamma_boot,F_VH_gamma_boot,MF_VH_gamma_p_test,MF_gammapjm_VH] = BootStat_MvF(M_VH_gamma,F_VH_gamma);
[M_VH_delta_boot,F_VH_delta_boot,MF_VH_delta_p_test,MF_deltapjm_VH] = BootStat_MvF(M_VH_delta,F_VH_delta);
 [M_PL_theta_boot,F_PL_theta_boot,MF_PL_theta_p_test,MF_thetapjm_PL] = BootStat_MvF(M_PL_theta,F_PL_theta); %mPFC-PL
 [M_PL_gamma_boot,F_PL_gamma_boot,MF_PL_gamma_p_test,MF_gammapjm_PL] = BootStat_MvF(M_PL_gamma,F_PL_gamma);
 [M_PL_delta_boot,F_PL_delta_boot,MF_PL_delta_p_test,MF_deltapjm_PL] = BootStat_MvF(M_PL_delta,F_PL_delta);
...
disp(T_MF)
clear *_p_test *_theta *_gamma *_delta
    
% Save the data
disp('Saving band power bootstrap statistics..')
fn = 'BandPowBootStats-BL-5to15-MvF.mat';
save([root_drIn '5to15' filesep fn],'T_MF','MF_*','*_boot','x','subjs','-v7.3')
disp('Saved!')
clear fn 
...
H121b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %dHPC
    ...
    xlabel('Theta band power (dB)'); ylabel('probability')
    title('dHPC');
saveas(H121b,[fd 'BandPowBoot_Theta_DH_MvF.fig'])
    legend('off')
saveas(H121b,[fd 'BandPowBoot_Theta_DH_MvF.png'])
    close(H121b); clear H121b ans
...
H121c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %vHPC
    ...
    xlabel('Theta band power (dB)'); ylabel('probability')
    title('vHPC');
saveas(H121c,[fd 'BandPowBoot_Theta_VH_MvF.fig'])
    legend('off')
saveas(H121c,[fd 'BandPowBoot_Theta_VH_MvF.png'])
    close(H121c); clear H121c ans
...
H122b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %dHPC
    ...
    xlabel('Gamma band power (dB)'); ylabel('probability')
    title('dHPC');
saveas(H122b,[fd 'BandPowBoot_Gamma_DH_MvF.fig'])
    legend('off')
saveas(H122b,[fd 'BandPowBoot_Gamma_DH_MvF.png'])
    close(H122b); clear H122b ans
...
H122c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %vHPC
    ...
    xlabel('Gamma band power (dB)'); ylabel('probability')
    title('vHPC');
saveas(H122c,[fd 'BandPowBoot_Gamma_VH_MvF.fig'])
    legend('off')
saveas(H122c,[fd 'BandPowBoot_Gamma_VH_MvF.png'])
    close(H122c); clear H122c ans
...
H123b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %dHPC
    ...
    xlabel('Delta band power (dB)'); ylabel('probability')
    title('dHPC');
saveas(H123b,[fd 'BandPowBoot_Delta_DH_MvF.fig'])
    legend('off')
saveas(H123b,[fd 'BandPowBoot_Delta_DH_MvF.png'])
    close(H123b); clear H123b ans
...
H123c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %vHPC
    ...
    xlabel('Delta band power (dB)'); ylabel('probability')
    title('vHPC');
saveas(H123c,[fd 'BandPowBoot_Delta_VH_MvF.fig'])
    legend('off')
saveas(H123c,[fd 'BandPowBoot_Delta_VH_MvF.png'])
    close(H123c); clear H123c ans
...
% Calculate direct probabilities (pboot values)
    % Theta
[fDP_IL_theta_p_test,fDP_IL_theta_pjm] = get_direct_prob(fD_IL_theta_boot, fP_IL_theta_boot); %mPFC-IL  proestrus vs diestrus
[fDE_IL_theta_p_test,fDE_IL_theta_pjm] = get_direct_prob(fD_IL_theta_boot, fE_IL_theta_boot); %diestrus vs estrus
[fPE_IL_theta_p_test,fPE_IL_theta_pjm] = get_direct_prob(fP_IL_theta_boot, fE_IL_theta_boot); %estrus vs proestrus
 [fDP_DH_theta_p_test,fDP_DH_theta_pjm] = get_direct_prob(fD_DH_theta_boot, fP_DH_theta_boot); %dHPC
 [fDE_DH_theta_p_test,fDE_DH_theta_pjm] = get_direct_prob(fD_DH_theta_boot, fE_DH_theta_boot);
 [fPE_DH_theta_p_test,fPE_DH_theta_pjm] = get_direct_prob(fP_DH_theta_boot, fE_DH_theta_boot);
[fDP_VH_theta_p_test,fDP_VH_theta_pjm] = get_direct_prob(fD_VH_theta_boot, fP_VH_theta_boot); %vHPC
[fDE_VH_theta_p_test,fDE_VH_theta_pjm] = get_direct_prob(fD_VH_theta_boot, fE_VH_theta_boot);
[fPE_VH_theta_p_test,fPE_VH_theta_pjm] = get_direct_prob(fP_VH_theta_boot, fE_VH_theta_boot);
 [fDP_PL_theta_p_test,fDP_PL_theta_pjm] = get_direct_prob(fD_PL_theta_boot, fP_PL_theta_boot); %mPFC-PL
 [fDE_PL_theta_p_test,fDE_PL_theta_pjm] = get_direct_prob(fD_PL_theta_boot, fE_PL_theta_boot);
 [fPE_PL_theta_p_test,fPE_PL_theta_pjm] = get_direct_prob(fP_PL_theta_boot, fE_PL_theta_boot);
    % Gamma
[fDP_IL_gamma_p_test,fDP_IL_gamma_pjm] = get_direct_prob(fD_IL_gamma_boot, fP_IL_gamma_boot); %mPFC-IL
[fDE_IL_gamma_p_test,fDE_IL_gamma_pjm] = get_direct_prob(fD_IL_gamma_boot, fE_IL_gamma_boot);
[fPE_IL_gamma_p_test,fPE_IL_gamma_pjm] = get_direct_prob(fP_IL_gamma_boot, fE_IL_gamma_boot);
 [fDP_DH_gamma_p_test,fDP_DH_gamma_pjm] = get_direct_prob(fD_DH_gamma_boot, fP_DH_gamma_boot); %dHPC
 [fDE_DH_gamma_p_test,fDE_DH_gamma_pjm] = get_direct_prob(fD_DH_gamma_boot, fE_DH_gamma_boot);
 [fPE_DH_gamma_p_test,fPE_DH_gamma_pjm] = get_direct_prob(fP_DH_gamma_boot, fE_DH_gamma_boot);
[fDP_VH_gamma_p_test,fDP_VH_gamma_pjm] = get_direct_prob(fD_VH_gamma_boot, fP_VH_gamma_boot); %vHPC
[fDE_VH_gamma_p_test,fDE_VH_gamma_pjm] = get_direct_prob(fD_VH_gamma_boot, fE_VH_gamma_boot);
[fPE_VH_gamma_p_test,fPE_VH_gamma_pjm] = get_direct_prob(fP_VH_gamma_boot, fE_VH_gamma_boot);
 [fDP_PL_gamma_p_test,fDP_PL_gamma_pjm] = get_direct_prob(fD_PL_gamma_boot, fP_PL_gamma_boot); %mPFC-PL
 [fDE_PL_gamma_p_test,fDE_PL_gamma_pjm] = get_direct_prob(fD_PL_gamma_boot, fE_PL_gamma_boot);
 [fPE_PL_gamma_p_test,fPE_PL_gamma_pjm] = get_direct_prob(fP_PL_gamma_boot, fE_PL_gamma_boot);
    % Delta
[fDP_IL_delta_p_test,fDP_IL_delta_pjm] = get_direct_prob(fD_IL_delta_boot, fP_IL_delta_boot); %mPFC-IL
[fDE_IL_delta_p_test,fDE_IL_delta_pjm] = get_direct_prob(fD_IL_delta_boot, fE_IL_delta_boot);
[fPE_IL_delta_p_test,fPE_IL_delta_pjm] = get_direct_prob(fP_IL_delta_boot, fE_IL_delta_boot);
 [fDP_DH_delta_p_test,fDP_DH_delta_pjm] = get_direct_prob(fD_DH_delta_boot, fP_DH_delta_boot); %dHPC
 [fDE_DH_delta_p_test,fDE_DH_delta_pjm] = get_direct_prob(fD_DH_delta_boot, fE_DH_delta_boot);
 [fPE_DH_delta_p_test,fPE_DH_delta_pjm] = get_direct_prob(fP_DH_delta_boot, fE_DH_delta_boot);
[fDP_VH_delta_p_test,fDP_VH_delta_pjm] = get_direct_prob(fD_VH_delta_boot, fP_VH_delta_boot); %vHPC
[fDE_VH_delta_p_test,fDE_VH_delta_pjm] = get_direct_prob(fD_VH_delta_boot, fE_VH_delta_boot);
[fPE_VH_delta_p_test,fPE_VH_delta_pjm] = get_direct_prob(fP_VH_delta_boot, fE_VH_delta_boot);
 [fDP_PL_delta_p_test,fDP_PL_delta_pjm] = get_direct_prob(fD_PL_delta_boot, fP_PL_delta_boot); %mPFC-PL
 [fDE_PL_delta_p_test,fDE_PL_delta_pjm] = get_direct_prob(fD_PL_delta_boot, fE_PL_delta_boot);
 [fPE_PL_delta_p_test,fPE_PL_delta_pjm] = get_direct_prob(fP_PL_delta_boot, fE_PL_delta_boot);
toc(tstart); clear tstart 

% Put p-values into tables
...
H141b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); % dHPC
    ...
    xlabel('Theta band power (dB)'); ylabel('probability')
    title('dHPC')
saveas(H141b,[fd 'BandPowBoot_Theta_DH_Estrous.fig'])
    legend('off')
saveas(H141b,[fd 'BandPowBoot_Theta_DH_Estrous.png'])
    close(H141b); clear H141b ans
...
H141c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); % vHPC
    ...
    xlabel('Theta band power (dB)'); ylabel('probability')
    title('vHPC')
saveas(H141c,[fd 'BandPowBoot_Theta_VH_Estrous.fig'])
    legend('off')
saveas(H141c,[fd 'BandPowBoot_Theta_VH_Estrous.png'])
    close(H141c); clear H141c ans
...
H142b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); % dHPC
    ...
    xlabel('Gamma band power (dB)'); ylabel('probability')
    title('dHPC')
saveas(H142b,[fd 'BandPowBoot_Gamma_DH_Estrous.fig'])
    legend('off')
saveas(H142b,[fd 'BandPowBoot_Gamma_DH_Estrous.png'])
    close(H142b); clear H142b ans
...
H142c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); % vHPC
    ...
    xlabel('Gamma band power (dB)'); ylabel('probability')
    title('vHPC')
saveas(H142c,[fd 'BandPowBoot_Gamma_VH_Estrous.fig'])
    legend('off')
saveas(H142c,[fd 'BandPowBoot_Gamma_VH_Estrous.png'])
    close(H142c); clear H142c ans
...
H143b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); % dHPC
    ...
    xlabel('Delta band power (dB)'); ylabel('probability')
    title('dHPC')
saveas(H143b,[fd 'BandPowBoot_Delta_DH_Estrous.fig'])
    legend('off')
saveas(H143b,[fd 'BandPowBoot_Delta_DH_Estrous.png'])
    close(H143b); clear H143b ans
...
H143c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); % vHPC
    ...
    xlabel('Delta band power (dB)'); ylabel('probability')
    title('vHPC')
saveas(H143c,[fd 'BandPowBoot_Delta_VH_Estrous.fig'])
    legend('off')
saveas(H143c,[fd 'BandPowBoot_Delta_VH_Estrous.png'])
    close(H143c); clear H143c ans
...
saveas(H161a,[fd 'BandPowBoot_Theta_IL_MvHorms.fig'])
    legend('off')
saveas(H161a,[fd 'BandPowBoot_Theta_IL_MvHorms.png'])
    close(H161a); clear H161a
...
H161b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %dHPC
    ...
    xlabel('Theta band power (dB)'); ylabel('probability')
    title('dHPC')
saveas(H161b,[fd 'BandPowBoot_Theta_DH_MvHorms.fig'])
    legend('off')
saveas(H161b,[fd 'BandPowBoot_Theta_DH_MvHorms.png'])
    close(H161b); clear H161b
...
H161c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %vHPC
    ...
    xlabel('Theta band power (dB)'); ylabel('probability')
    title('vHPC')
saveas(H161c,[fd 'BandPowBoot_Theta_VH_MvHorms.fig'])
    legend('off')
saveas(H161c,[fd 'BandPowBoot_Theta_VH_MvHorms.png'])
    close(H161c); clear H161c
...
saveas(H161d,[fd 'BandPowBoot_Theta_PL_MvHorms.png'])
    close(H161d); clear H161d
disp('Theta band power figures saved: MvHorms')
clear *_theta_boot ans
...
saveas(H162a,[fd 'BandPowBoot_Gamma_IL_MvHorms.fig'])
    legend('off')
saveas(H162a,[fd 'BandPowBoot_Gamma_IL_MvHorms.png'])
    close(H162a); clear H162a
...
H162b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %dHPC
    ...
    xlabel('Gamma band power (dB)'); ylabel('probability')
    title('dHPC')
saveas(H162b,[fd 'BandPowBoot_Gamma_DH_MvHorms.fig'])
    legend('off')
saveas(H162b,[fd 'BandPowBoot_Gamma_DH_MvHorms.png'])
    close(H162b); clear H162b
...
H162c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %vHPC
    ...
    xlabel('Gamma band power (dB)'); ylabel('probability')
    title('vHPC')
saveas(H162c,[fd 'BandPowBoot_Gamma_VH_MvHorms.fig'])
    legend('off')
saveas(H162c,[fd 'BandPowBoot_Gamma_VH_MvHorms.png'])
    close(H162c); clear H162c
...
saveas(H162d,[fd 'BandPowBoot_Gamma_PL_MvHorms.png'])
    close(H162d); clear H162d
disp('Gamma band power figures saved: MvHorms')
clear *_gamma_boot ans
...
saveas(H163a,[fd 'BandPowBoot_Delta_IL_MvHorms.fig'])
    legend('off')
saveas(H163a,[fd 'BandPowBoot_Delta_IL_MvHorms.png'])
    close(H163a); clear H163a
...
H163b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %dHPC
    ...
    xlabel('Delta band power (dB)'); ylabel('probability')
    title('dHPC')
saveas(H163b,[fd 'BandPowBoot_Delta_DH_MvHorms.fig'])
    legend('off')
saveas(H163b,[fd 'BandPowBoot_Delta_DH_MvHorms.png'])
    close(H163b); clear H163b
...
H163c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %vHPC
    ...
    xlabel('Delta band power (dB)'); ylabel('probability')
    title('vHPC')
saveas(H163c,[fd 'BandPowBoot_Delta_VH_MvHorms.fig'])
    legend('off')
saveas(H163c,[fd 'BandPowBoot_Delta_VH_MvHorms.png'])
    close(H163c); clear H163c
...
% Clean up workspace
clear f_n Connection Bands nboot
