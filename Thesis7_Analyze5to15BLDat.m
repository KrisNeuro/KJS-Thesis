...
saveas(H121a,[fd 'BandPowBoot_Theta_IL_MvF.svg']);
...
saveas(H121b,[fd 'BandPowBoot_Theta_DH_MvF.svg']);
...
saveas(H121c,[fd 'BandPowBoot_Theta_VH_MvF.svg']);
...
saveas(H121d,[fd 'BandPowBoot_Theta_PL_MvF.svg']);
...
saveas(H122a,[fd 'BandPowBoot_Gamma_IL_MvF.svg']);
...
saveas(H122b,[fd 'BandPowBoot_Gamma_DH_MvF.svg']);
...
saveas(H122c,[fd 'BandPowBoot_Gamma_VH_MvF.svg']);
...
saveas(H122d,[fd 'BandPowBoot_Gamma_PL_MvF.svg']);
...
saveas(H123a,[fd 'BandPowBoot_Delta_IL_MvF.svg']);
...
saveas(H123b,[fd 'BandPowBoot_Delta_DH_MvF.svg']);
...
saveas(H123c,[fd 'BandPowBoot_Delta_VH_MvF.svg']);
...
saveas(H123d,[fd 'BandPowBoot_Delta_PL_MvF.svg']);
...
saveas(H141a,[fd 'BandPowBoot_Theta_IL_Estrous.svg']);
...
saveas(H141b,[fd 'BandPowBoot_Theta_DH_Estrous.svg']);
...
saveas(H141c,[fd 'BandPowBoot_Theta_VH_Estrous.svg']);
...
saveas(H141d,[fd 'BandPowBoot_Theta_PL_Estrous.svg']);
...
saveas(H142a,[fd 'BandPowBoot_Gamma_IL_Estrous.svg']);
...
saveas(H142b,[fd 'BandPowBoot_Gamma_DH_Estrous.svg']);
...
saveas(H142c,[fd 'BandPowBoot_Gamma_VH_Estrous.svg']);
...
saveas(H142d,[fd 'BandPowBoot_Gamma_PL_Estrous.svg']);
...
saveas(H143a,[fd 'BandPowBoot_Delta_IL_Estrous.svg']);
...
saveas(H143b,[fd 'BandPowBoot_Delta_DH_Estrous.svg']);
...
saveas(H143c,[fd 'BandPowBoot_Delta_VH_Estrous.svg']);
...
saveas(H143d,[fd 'BandPowBoot_Delta_PL_Estrous.svg']);
...
saveas(H161a,[fd 'BandPowBoot_Theta_IL_MvHorms.svg']);
...
saveas(H161b,[fd 'BandPowBoot_Theta_DH_MvHorms.svg']);
...
saveas(H161c,[fd 'BandPowBoot_Theta_VH_MvHorms.svg']);
...
saveas(H161d,[fd 'BandPowBoot_Theta_PL_MvHorms.svg']);
...
saveas(H162a,[fd 'BandPowBoot_Gamma_IL_MvHorms.svg']);
...
saveas(H162b,[fd 'BandPowBoot_Gamma_DH_MvHorms.svg']);
...
saveas(H162c,[fd 'BandPowBoot_Gamma_VH_MvHorms.svg']);
...
saveas(H162d,[fd 'BandPowBoot_Gamma_PL_MvHorms.svg']);
...
saveas(H163a,[fd 'BandPowBoot_Delta_IL_MvHorms.svg']);
...
saveas(H163b,[fd 'BandPowBoot_Delta_DH_MvHorms.svg']);
...
saveas(H163c,[fd 'BandPowBoot_Delta_VH_MvHorms.svg']);
...
saveas(H163d,[fd 'BandPowBoot_Delta_PL_MvHorms.svg']);
...
saveas(H22a,[fd 'ThetaPhaseLagBoot_ILDH_MvF.svg']);
...
saveas(H22b,[fd 'ThetaPhaseLagBoot_ILVH_MvF.svg']);
...
saveas(H22c,[fd 'ThetaPhaseLagBoot_DHPL_MvF.svg']);
...
saveas(H22d,[fd 'ThetaPhaseLagBoot_VHPL_MvF.svg']);
saveas(H22d,[fd 'ThetaPhaseLagBoot_VHPL_MvF.png']); close(H22d); clear H22d ans

%ILPL
H22e = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]);
    PlotHistBoot_MF(gca,M_ILPL_boot,F_ILPL_boot);
    xlabel('Theta phase lag: width @ half-max (rad.)'); title('IL-PrL')
saveas(H22e,[fd 'ThetaPhaseLagBoot_ILPL_MvF.fig']); legend('off')
saveas(H22e,[fd 'ThetaPhaseLagBoot_ILPL_MvF.svg']);
saveas(H22e,[fd 'ThetaPhaseLagBoot_ILPL_MvF.png']); close(H22e); clear H22e ans

%DHVH
H22f = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]);
    PlotHistBoot_MF(gca,M_DHVH_boot,F_DHVH_boot);
    xlabel('Theta phase lag: width @ half-max (rad.)'); title('dHPC-vHPC')
saveas(H22f,[fd 'ThetaPhaseLagBoot_DHVH_MvF.fig']); legend('off')
saveas(H22f,[fd 'ThetaPhaseLagBoot_DHVH_MvF.svg']);
saveas(H22f,[fd 'ThetaPhaseLagBoot_DHVH_MvF.png']); close(H22f); clear H22f ans
...
saveas(H24a,[fd 'ThetaPhaseLagBoot_ILDH_Estrous.svg']);
...
saveas(H24b,[fd 'ThetaPhaseLagBoot_ILVH_Estrous.svg']);
...
saveas(H24c,[fd 'ThetaPhaseLagBoot_DHPL_Estrous.svg']);
...
saveas(H24d,[fd 'ThetaPhaseLagBoot_VHPL_Estrous.svg']);
saveas(H24d,[fd 'ThetaPhaseLagBoot_VHPL_Estrous.png']); close(H24d); clear H24d ans

H24e = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %ILPL
    PlotHistBoot_Estrous(gca,fD_ILPL_boot,fP_ILPL_boot,fE_ILPL_boot);
    xlabel('Theta phase lag: width @ half-max (rad.)'); title('IL-PrL')
saveas(H24e,[fd 'ThetaPhaseLagBoot_ILPL_Estrous.fig']); legend('off')
saveas(H24e,[fd 'ThetaPhaseLagBoot_ILPL_Estrous.svg']);
...
saveas(H24f,[fd 'ThetaPhaseLagBoot_DHVH_Estrous.png']); close(H24f); clear H24f ans
...
saveas(H26a,[fd 'ThetaPhaseLagBoot_ILDH_MvHorms.svg']);
...
saveas(H26b,[fd 'ThetaPhaseLagBoot_ILVH_MvHorms.svg']);
...
saveas(H26c,[fd 'ThetaPhaseLagBoot_DHPL_MvHorms.svg']);
...
saveas(H26d,[fd 'ThetaPhaseLagBoot_VHPL_MvHorms.svg']);
saveas(H26d,[fd 'ThetaPhaseLagBoot_VHPL_MvHorms.png']); close(H26d); clear H26d ans

H26e = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %ILPL
    PlotHistBoot_MvHorms(gca,M_ILPL_boot,fD_ILPL_boot,fP_ILPL_boot,fE_ILPL_boot);
    xlabel('Theta phase lag: width @ half-max (rad.)'); title('IL-PrL')
saveas(H26e,[fd 'ThetaPhaseLagBoot_ILPL_MvHorms.fig']); legend('off')
saveas(H26e,[fd 'ThetaPhaseLagBoot_ILPL_MvHorms.svg']);
saveas(H26e,[fd 'ThetaPhaseLagBoot_ILPL_MvHorms.png']); close(H26e); clear H26e ans

H26f = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %DHVH
    PlotHistBoot_MvHorms(gca,M_DHVH_boot,fD_DHVH_boot,fP_DHVH_boot,fE_DHVH_boot);
    xlabel('Theta phase lag: width @ half-max (rad.)'); title('dHPC-vHPC')
saveas(H26f,[fd 'ThetaPhaseLagBoot_DHVH_MvHorms.fig']); legend('off') 
saveas(H26f,[fd 'ThetaPhaseLagBoot_DHVH_MvHorms.svg']);
saveas(H26f,[fd 'ThetaPhaseLagBoot_DHVH_MvHorms.png']); close(H26f); clear H26f ans
...
for bi = 1:length(Bands) %loop: theta, gamma, delta bands
    ...
    saveas(H32a,[fd Bands{bi} 'RSqBoot_ILDH_MvF.svg']);
    ...
    saveas(H32b,[fd Bands{bi} 'RSqBoot_ILVH_MvF.svg']);
    ...
    saveas(H32c,[fd Bands{bi} 'RSqBoot_DHPL_MvF.svg']);
    ...
    saveas(H32d,[fd Bands{bi} 'RSqBoot_VHPL_MvF.svg']);
    ...
    saveas(H32e,[fd Bands{bi} 'RSqBoot_ILPL_MvF.svg']);
    ...
    saveas(H32f,[fd Bands{bi} 'RSqBoot_DHVH_MvF.svg']);
   ...
   toc(tstart); clear tstart  
    ...
    saveas(H34a,[fd Bands{bi} 'RSqBoot_ILDH_Estrous.svg']);
    ...
    H34b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %ILVH
        PlotHistBoot_Estrous(gca,fD_ILVH_boot,fP_ILVH_boot,fE_ILVH_boot);
        xlabel(sprintf('%s Power Correlations (R^2)',Bands{bi})); title('vHPC-IL')
    saveas(H34b,[fd Bands{bi} 'RSqBoot_ILVH_Estrous.fig']); legend('off')
    saveas(H34b,[fd Bands{bi} 'RSqBoot_ILVH_Estrous.svg']);
    ...
    H34c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %DHPL
        PlotHistBoot_Estrous(gca,fD_DHPL_boot,fP_DHPL_boot,fE_DHPL_boot);
        xlabel(sprintf('%s Power Correlations (R^2)',Bands{bi})); title('dHPC-PrL')
    saveas(H34c,[fd Bands{bi} 'RSqBoot_DHPL_Estrous.fig']); legend('off')
    saveas(H34c,[fd Bands{bi} 'RSqBoot_DHPL_Estrous.svg']);
    saveas(H34c,[fd Bands{bi} 'RSqBoot_DHPL_Estrous.png']); close(H34c); clear H34c ans
    ...
    saveas(H34d,[fd Bands{bi} 'RSqBoot_VHPL_Estrous.svg']);
    ...
    saveas(H34e,[fd Bands{bi} 'RSqBoot_ILPL_Estrous.svg']);
    ...
    saveas(H34f,[fd Bands{bi} 'RSqBoot_DHVH_Estrous.svg']);
    ...
    H36a = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %ILDH
        PlotHistBoot_MvHorms(gca,M_ILDH_boot,fD_ILDH_boot,fP_ILDH_boot,fE_ILDH_boot);
        xlabel(sprintf('%s Power Correlations (R^2)',Bands{bi})); title('dHPC-IL')
    saveas(H36a,[fd Bands{bi} 'RSqBoot_ILDH_MvHorms.fig']); legend('off')
    saveas(H36a,[fd Bands{bi} 'RSqBoot_ILDH_MvHorms.svg']);
    saveas(H36a,[fd Bands{bi} 'RSqBoot_ILDH_MvHorms.png']); close(H36a); clear H36a ans
        
    H36b = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %ILVH
        PlotHistBoot_MvHorms(gca,M_ILVH_boot,fD_ILVH_boot,fP_ILVH_boot,fE_ILVH_boot);
        xlabel(sprintf('%s Power Correlations (R^2)',Bands{bi})); title('vHPC-IL')
    saveas(H36b,[fd Bands{bi} 'RSqBoot_ILVH_MvHorms.fig']); legend('off')
    saveas(H36b,[fd Bands{bi} 'RSqBoot_ILVH_MvHorms.svg']);
    saveas(H36b,[fd Bands{bi} 'RSqBoot_ILVH_MvHorms.png']); close(H36b); clear H36b ans
        
    H36c = figure('units','normalized','position',[0.1042 0.0380 0.5182 0.8833]); %DHPL
        PlotHistBoot_MvHorms(gca,M_DHPL_boot,fD_DHPL_boot,fP_DHPL_boot,fE_DHPL_boot);
        xlabel(sprintf('%s Power Correlations (R^2)',Bands{bi})); title('dHPC-PrL')
    saveas(H36c,[fd Bands{bi} 'RSqBoot_DHPL_MvHorms.fig']);  legend('off')
    saveas(H36c,[fd Bands{bi} 'RSqBoot_DHPL_MvHorms.svg']);
    saveas(H36c,[fd Bands{bi} 'RSqBoot_DHPL_MvHorms.png']); close(H36c); clear H36c ans
    ...
    saveas(H36d,[fd Bands{bi} 'RSqBoot_VHPL_MvHorms.svg']);
    ...
    saveas(H36e,[fd Bands{bi} 'RSqBoot_ILPL_MvHorms.svg']);
    ...
    saveas(H36f,[fd Bands{bi} 'RSqBoot_DHVH_MvHorms.svg']);
