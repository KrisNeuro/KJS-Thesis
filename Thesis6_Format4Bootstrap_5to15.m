...
%% 1. Format for bootstrap: LFP data, BL arena, all trials                  (OK) Relatively quick runtime, saving takes a few mins
...
%% 2.1 Calculate Power Spectra: One curve per subject                       (OK)  Slower runtime, requires more RAM. Quick save
...
%% 2.2 Calculate female Power Spectra: Separate each subj by estrous stage  (OK) Slower runtime, requires more RAM. Quick save
% Uses data generated by Format4Bootstrap_LFP.m (above)
...
%% 2.3 Plot Power Spectra & Functional statistical tests: Sex Differences    (OK) Fast run and save
...
%% 2.4 Plot Power Spectra & Functional statistical tests: Females only/Estrous stages    (OK) Fast run and save
...
%% 3 Calculate band power in theta, gamma, and delta bands                % ok. Load LFP takes a min, PowSpecTrials takes significant time. Format4Bootstrap_BandPower2 & save is instant
