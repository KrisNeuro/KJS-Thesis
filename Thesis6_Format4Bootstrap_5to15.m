...
[H6,VHPLstat] = PlotBoot_mscohereHormones(f,A,Dvhpl,Pvhpl,Evhpl,Mvhpl);
    ...
    % Save figures
    fd = [figdrOut 'Cohereograms\FunctionalAnova\']; %output directory
    saveas(H1,[fd 'ILDHmscohere-Hormones-SubjSEM-5to15BL.png'])
    saveas(H1,[fd 'ILDHmscohere-Hormones-SubjSEM-5to15BL.fig'])
        close(H1); clear H1
    saveas(H2,[fd 'ILVHmscohere-Hormones-SubjSEM-5to15BL.png'])
    saveas(H2,[fd 'ILVHmscohere-Hormones-SubjSEM-5to15BL.fig'])
        close(H2); clear H2
    saveas(H3,[fd 'ILPLmscohere-Hormones-SubjSEM-5to15BL.png'])
    saveas(H3,[fd 'ILPLmscohere-Hormones-SubjSEM-5to15BL.fig'])
        close(H3); clear H3
    saveas(H4,[fd 'DHVHmscohere-Hormones-SubjSEM-5to15BL.png'])
    saveas(H4,[fd 'DHVHmscohere-Hormones-SubjSEM-5to15BL.fig'])
        close(H4); clear H4
    saveas(H5,[fd 'DHPLmscohere-Hormones-SubjSEM-5to15BL.png'])
    saveas(H5,[fd 'DHPLmscohere-Hormones-SubjSEM-5to15BL.fig'])
        close(H5); clear H5
    saveas(H6,[fd 'VHPLmscohere-Hormones-SubjSEM-5to15BL.png'])
...
clear M* 
    % Save figures
    saveas(h1,[fd 'ILDHmscohere-HormonesBands-SubjSEM-5to15BL.png'])
    saveas(h1,[fd 'ILDHmscohere-HormonesBands-SubjSEM-5to15BL.fig'])
        close(h1); clear h1
    saveas(h2,[fd 'ILVHmscohere-HormonesBands-SubjSEM-5to15BL.png'])
    saveas(h2,[fd 'ILVHmscohere-HormonesBands-SubjSEM-5to15BL.fig'])
        close(h2); clear h2
    saveas(h3,[fd 'ILPLmscohere-HormonesBands-SubjSEM-5to15BL.png'])
    saveas(h3,[fd 'ILPLmscohere-HormonesBands-SubjSEM-5to15BL.fig'])
        close(h3); clear h3
    saveas(h4,[fd 'DHVHmscohere-HormonesBands-SubjSEM-5to15BL.png'])
    saveas(h4,[fd 'DHVHmscohere-HormonesBands-SubjSEM-5to15BL.fig'])
        close(h4); clear h4
    saveas(h5,[fd 'DHPLmscohere-HormonesBands-SubjSEM-5to15BL.png'])
    saveas(h5,[fd 'DHPLmscohere-HormonesBands-SubjSEM-5to15BL.fig'])
        close(h5); clear h5
    saveas(h6,[fd 'VHPLmscohere-HormonesBands-SubjSEM-5to15BL.png'])
