...
F_ILDH_E,F_ILVH_E,F_ILPL_E,F_DHVH_E,F_DHPL_E,F_VHPL_E,F_ILDH_M,F_ILVH_M,F_ILPL_M,F_DHVH_M,F_DHPL_M,F_VHPL_M] = Format4Bootstrap_Rsq(subjs,drIn,IDX,Band)
...
%     = Format4Bootstrap_Rsq(subjs,drIn,IDX,Band)
% 
